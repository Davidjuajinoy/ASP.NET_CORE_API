...
{
    /// <summary>
    /// Require instalar Microsoft.EntityFrameworkCore.SqlServer y
    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        //override ctr+space para completado
        ...
        //para la relacion de ManytoMany MOVIES - GENRES guarda el id de la pelicula y el id del genero  
        public DbSet<MoviesActors> MoviesActors { get; set; }
        //para la relacion de ManytoMany Movies - Person guarda el id de la pelicula y el id del protagonista  
